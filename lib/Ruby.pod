...
If I<package> is suplied, those classes and functions that are defined in
I<source> are imported to I<package> automatically.
...
Obtains the defined I<class>, I<module> or I<exeption> object.
...
Ruby's C<callcc> and C<catch/throw> will throw C<LocalJumpError>.
...
Copyright (c) 2008, Goro Fuji. All rights reserved.
